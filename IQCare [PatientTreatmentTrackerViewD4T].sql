...
/****** Object:  View [dbo].[PatientTreatmentTrackerViewD4T]    Script Date: 10/3/2018 8:55:39 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[PatientTreatmentTrackerViewD4T] AS (
...
SELECT        R.RegimenMap_Pk, R.patientId, R.ptn_pk, 0 AS ServiceAreaId, 0 AS PatientmasterVisitId,
                             ...
                             ((SELECT        TOP 1 id
                                 FROM            LookupItem
                                 WHERE        Name IN (CASE (isnull(ascii(SUBSTRING(R.regimentype, 1, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 2, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 3, 1)), 0) 
                                                          + isnull(ascii(SUBSTRING(R.regimentype, 4, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 5, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 6, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 7, 1)), 0) 
                                                          + isnull(ascii(SUBSTRING(R.regimentype, 8, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 9, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 10, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 11, 1)), 0) 
                                                          + isnull(ascii(SUBSTRING(R.regimentype, 12, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 13, 1)), 0)) 
														  ...
														  WHEN 729 /*'3TC/ABC/ATV'*/ THEN CASE WHEN R.age >= 15 THEN 'AS5B' ELSE 'CS2C' END 
														  WHEN 744 /*'3TC/D4T/NVP'*/ THEN CASE WHEN R.age >= 15 THEN 'AF3A' ELSE 'AF3B' END 
														  WHEN 725 /*'3TC/D4T/EFV'*/ THEN CASE WHEN R.age >= 15 THEN 'CF3A' ELSE 'CF3B' END 
														  WHEN 917 /*'ABC/LPV/r/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AS2D' ELSE 'AS2D' END 														  
														  /*WHEN 717 /*'3TC/ABC/RAL'*/ THEN CASE WHEN R.age < 15 THEN 'CF2F' END /*'ABC + 3TC + RAL'*/*/ END)),
                          0) AS RegimenId, 
						  ISNULL(
						  (CASE (isnull(ascii(SUBSTRING(R.regimentype, 1, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 2, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 3, 1)), 0) 
                         + isnull(ascii(SUBSTRING(R.regimentype, 4, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 5, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 6, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 7, 1)), 0) 
                         + isnull(ascii(SUBSTRING(R.regimentype, 8, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 9, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 10, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 11, 1)), 0) 
                         + isnull(ascii(SUBSTRING(R.regimentype, 12, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 13, 1)), 0)) 
							WHEN 779 /*'3TC/AZT/NVP'*/ THEN CASE WHEN R.age >= 15 THEN
								 ...
								 (SELECT        TOP 1 Name
								   FROM            lookupitem
                               WHERE        Name = 'CF1A') END + '(AZT + 3TC + NVP)' 
							WHEN 760 /*'3TC/AZT/EFV'*/ THEN CASE WHEN R.age >= 15 THEN
								 (SELECT        TOP 1 Name
								   FROM            lookupitem
								   WHERE        Name = 'AF1B') ELSE
								 (SELECT        TOP 1 Name
								   FROM            lookupitem
								   WHERE        Name = 'CF1B') END + '(AZT + 3TC + EFV)' 
							WHEN 758 /*'3TC/AZT/DTG'*/ THEN CASE WHEN R.age >= 15 THEN
								 (SELECT        TOP 1 Name
								   FROM            lookupitem
								 ...
								 (SELECT        TOP 1 Name
								   FROM            lookupitem
								   WHERE        Name = 'CF4A') END + '(TDF + 3TC + NVP)' 
							WHEN 743 /*'3TC/EFV/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF2B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF4B') END + '(TDF + 3TC + EFV)' 
							WHEN 741 /*'3TC/DTG/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF2E') END + '(TDF + 3TC + DTG)' 
							WHEN 867 /*'3TC/LOPr/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF2F') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF4C') END + '(TDF + 3TC + LPV/r)' 
							WHEN 921 /*'3TC/LPV/r/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF2F') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF4C') END + '(TDF + 3TC + LPV/r)' 
							WHEN 933 /*'FTC/ATV/r/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF2H') END + '(TDF + FTC + ATV/r)' 
							WHEN 738 /*'3TC/ABC/NVP'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF4A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF2A') END + '(ABC + 3TC + NVP)' 
							WHEN 719 /*'3TC/ABC/EFV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF4B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF2B') END + '(ABC + 3TC + EFV)' 
							WHEN 717 /*'3TC/ABC/DTG'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF4C') END + '(ABC + 3TC + DTG)' 
							WHEN 938 /*'3TC/AZT/LPV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS1A') END + '(AZT + 3TC + LPV/r)' 
							WHEN 884 /*'3TC/AZT/LOPr'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS1A') END + '(AZT + 3TC + LPV/r)' 
							WHEN 770 /*'3TC/AZT/ATV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS1B') END + '(AZT + 3TC + ATV/r)' 
							WHEN 931 /*'3TC/AZT/ATV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS1B') END + '(AZT + 3TC + ATV/r)' 
							WHEN 921 /*'3TC/TDF/LPV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2A') END + '(TDF + 3TC + LPV/r)' 
							WHEN 867 /*'3TC/TDF/LOPr'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2A') END + '(TDF + 3TC + LPV/r)' 
							WHEN 753 /*'3TC/TDF/ATV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2C') END + '(TDF + 3TC + ATV/r)' 
							WHEN 914 /*'3TC/TDF/ATV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2C') END + '(TDF + 3TC + ATV/r)' 
							WHEN 843 /*'3TC/ABC/LOPr'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS5A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS2A') END + '(ABC + 3TC + LPV/r)' 
							WHEN 897 /*'3TC/ABC/LPV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS5A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS2A') END + '(ABC + 3TC + LPV/r)' 
							WHEN 890 /*'3TC/ABC/ATV/r'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS5B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS2C') END + '(ABC + 3TC + ATV/r)' 
							WHEN 744 /*'3TC/D4T/EFV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF3A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AF3B') END + '(3TC + D4T + EFV)' 
							WHEN 725 /*'3TC/D4T/EFV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF3A') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CF3B') END + '(3TC + D4T + EFV)' 
							WHEN 917 /*'ABC/LPV/r/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2D') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2D') END + '(TDF + ABC + LPV/r)'
							WHEN 698 /*'3TC/ABC/D4T'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS4B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS4B') END + '(d4T + 3TC + ABC)'
							WHEN 757 /*'3TC/AZT/TDF'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2C') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS2C') END + '(TDF + 3TC + AZT)'							   
							WHEN 733 /*'3TC/ABC/AZT'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1C') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS1C') END + '(AZT + 3TC + ABC)'							   
							WHEN 729 /*'3TC/ABC/ATV'*/ THEN CASE WHEN R.age >= 15 THEN
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'AS5B') ELSE
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'CS2C') END + '(ABC + 3TC + ATV/r)' END),
                             (SELECT        TOP 1 Name
                               FROM            lookupitem
                               WHERE        Name = 'Unknown')) AS Regimen, 
							   ISNULL
                             ((SELECT        TOP 1 id
                                 FROM            LookupItem
                                 WHERE        Name IN
                                                              (SELECT        CASE MasterName WHEN 'AdultFirstLineRegimen' THEN 'AdultARTFirstLine' WHEN 'AdultSecondlineRegimen' THEN 'AdultARTSecondLine' WHEN 'AdultThirdlineRegimen' THEN 'AdultARTThirdLine'
                                                                ...
                                                                WHERE        ItemName IN /*C(ASE R.RegimenType */ (CASE (isnull(ascii(SUBSTRING(R.regimentype, 1, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 2, 1)), 0) + isnull(ascii(SUBSTRING(R.regimentype, 3, 1)), 
                                                                                          ...
                                                                                          WHEN 779 /*'3TC/AZT/NVP'*/ THEN CASE WHEN R.age >= 15 THEN 'AF1A' ELSE 'CF1A' END /*'AZT + 3TC + NVP'*/ WHEN 760 /*'3TC/AZT/EFV'*/ THEN CASE WHEN R.age >= 15 THEN 'AF1B' ELSE 'CF1B'
                                                                                           ...
                                                                                           'AF2A' ELSE 'CF4A' END /*TDF + 3TC + NVP*/ WHEN 743 /*'3TC/EFV/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2B' ELSE 'CF4B' END /*WHEN 753 /*'3TC/ATV/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2D' ELSE 'CF4D' END /*'TDF + 3TC + ATV/r'*/*/ WHEN
                                                                                           741 /*'3TC/DTG/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2E' END /*'TDF + 3TC + DTG'*/ WHEN 867 /*'3TC/LOPr/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2F' ELSE 'CF4C' END /*'TDF + 3TC + LPV/r'*/ WHEN
                                                                                           921 /*'3TC/LPV/r/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2F' ELSE 'CF4C' END /*WHEN 741 /*'3TC/RAL/TDF'*/ THEN CASE WHEN R.age >= 15 THEN 'AF2G' END /*'TDF + 3TC + RAL'*/*/ WHEN
                                                                                           ...
                                                                                           CASE WHEN R.age >= 15 THEN 'AS2C' END /*'TDF + 3TC + ATV/r'*/ WHEN 843 /*'3TC/ABC/LOPr'*/ THEN CASE WHEN R.age >= 15 THEN 'AS5A' ELSE 'CS2A' END /*'ABC + 3TC + LPV/r'*/ WHEN 897 /*'3TC/ABC/LPV/r'*/ THEN
                                                                                           CASE WHEN R.age >= 15 THEN 'AS5A' ELSE 'CS2A' END /*'ABC + 3TC + LPV/r'*/ WHEN 890 /*'3TC/ABC/ATV/r'*/ THEN CASE WHEN R.age >= 15 THEN 'AS5B' ELSE 'CS2C' END /*'ABC + 3TC + ATV/r'*/ WHEN
                                                                                           729 /*'3TC/ABC/ATV'*/ THEN CASE WHEN R.age >= 15 THEN 'AS5B' ELSE 'CS2C' END /*'ABC + 3TC + ATV/r'*/ END))),
                             (SELECT        TOP 1 Id
                               FROM            lookupitem
