...
SELECT a.PatientID AS ID, a.EnrollmentNumber as PatientId,a.PatientName,a.sex,a.PhoneNumber,a.currentAge, a.[EnrollmentDate ] as RegistrationDate,a.NextAppointmentDate,v.VLDate as LastVLDate, v.VLResults as LastVL,a.PatientStatus FROM all_Patients_cte a 
